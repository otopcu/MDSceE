...
/**
 * This is the item provider adapter for a {@link ConceptualScenarioMetaModel.StateMachine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StateMachineItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ConceptualScenarioMetaModelPackage.Literals.STATE_MACHINE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ConceptualScenarioMetaModelPackage.Literals.STATE_MACHINE__STATES);
			childrenFeatures.add(ConceptualScenarioMetaModelPackage.Literals.STATE_MACHINE__CON_ENT);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ConceptualScenarioMetaModelPackage.Literals.STATE_MACHINE__STATES,
				 ConceptualScenarioMetaModelFactory.eINSTANCE.createState()));

		newChildDescriptors.add
			(createChildParameter
				(ConceptualScenarioMetaModelPackage.Literals.STATE_MACHINE__CON_ENT,
